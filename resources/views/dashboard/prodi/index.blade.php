        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Prodi</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">Prodi</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('prodi.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_prodi" class="form-control" id="nama" aria-describedby="emailHelp" placeholder="contoh: D3 Teknik Informatika PSDKU Lamongan">
                                    </div>
                ...
                @foreach ($prodis as $prodi)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('prodi.destroy', $prodi->id) }}" method="post" class="d-inline delete-form">
                                @csrf
                                @method('delete')
