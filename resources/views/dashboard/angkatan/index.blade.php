        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Tahun Angkatan</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="{{ route('dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">Tahun Angkatan</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('angkatan.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="tahun_angkatan" class="form-control" id="nama" aria-describedby="emailHelp" placeholder="contoh: 2024">
                                    </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($angkatans as $angkat)
                    <tr>
                        ...
                        <td>{{ $angkat->tahun_angkatan }}</td>
                        <td>
                            <a href="{{ route('angkatan.edit', $angkat->id) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('angkatan.destroy', $angkat->id) }}" method="post" class="d-inline delete-form">
                                @csrf
                                @method('delete')
