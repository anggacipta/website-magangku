        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Lowongan Magang</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none" href="../main/index.html">Home</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">Lowongan Magang</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
...
{{--                                                </li>--}}
{{--                                                <li></li>--}}
{{--                                            </div></div></div></div><div class="simplebar-placeholder" style="width: 265px; height: 458px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></ul>--}}
{{--                    </div>--}}
                    <div class="app-invoice">
                            ...
                            @foreach ($lowonganMagangs as $lowongan)
                                    <li>
                                        <a href="javascript:void(0)" class="p-3 bg-hover-light-black border-bottom d-flex align-items-start invoice-user listing-user" id="invoice-{{ $lowongan->id }}" data-invoice-id="{{ $lowongan->id }}">
                                            ...
                                            <div class="ms-3 d-inline-block w-75">
                                                <h6 class="mb-0 invoice-customer">{{ $lowongan->judul }}</h6>
                                                <span class="fs-3 invoice-id text-truncate text-body-color d-block w-85">#{{ $lowongan->deskripsi }}</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const invoiceUsers = document.querySelectorAll('.invoice-user');
            const invoiceDetails = document.querySelectorAll('[id^="printableArea"]');

            invoiceUsers.forEach(user => {
                user.addEventListener('click', function () {
                    const invoiceId = this.getAttribute('data-invoice-id');
                    invoiceDetails.forEach(detail => {
                        if (detail.classList.contains(`invoice-${invoiceId}`)) {
