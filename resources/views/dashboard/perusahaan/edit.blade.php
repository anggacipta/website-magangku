...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Edit Data Perusahaan</h5>
                <div class="card">
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form id="barangForm" action="{{ route('perusahaan.update', $user->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
